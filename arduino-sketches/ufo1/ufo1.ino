/**
 *  helixMetal1 -- test sketch for helixMetal1 w/ pot control board
...
#define NUM_LEDS    98     // helixMetal1
...
uint8_t gMode = 3; // Index number of which mode is current
...
//        colorNew = c;
//        cAmount++;
//        cAmount = constrain(cAmount, 0, 254);     
    }
...
//        leds[ beatsin16(i+7,0,NUM_LEDS)] |= CHSV(dothue, 200, 255);
        leds[ beatsin16(i+2,0,NUM_LEDS)] |= CHSV(dothue, 255, 255);
        dothue += 32;
    }
}
