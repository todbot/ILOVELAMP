...
const uint8_t kMatrixHeight = 33;
...
// define for RGB or WWA strips, undefine for RGBW
//#define RGBONLY
...
Encoder knobA( butt2Pin, butt3Pin );
...
void modeLamp()
{
    int knobdiff = knobval - knobvallast;
    knobvallast = knobval;
    gColorsPos = gColorsPos + (knobdiff / 2);
    gColorsPos = gColorsPos % ARRAY_SIZE(gColors); // wrap around
    gColor = gColors[gColorsPos];
...
void debugPrint()
{
    ...
    Serial.print(gBri); Serial.print(F(":"));
    ...
    Serial.print(knobval); Serial.print(F(" : "));
